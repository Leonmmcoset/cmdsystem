...
class QGraphicsObject(__PyQt5_QtCore.QObject, QGraphicsItem):
    """ QGraphicsObject(parent: Optional[QGraphicsItem] = None) """
    ...
    def event(self, ev, QEvent=None): # real signature unknown; restored from __doc__
        """ event(self, ev: Optional[QEvent]) -> bool """
        return False

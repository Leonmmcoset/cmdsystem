...
class QGraphicsOpacityEffect(QGraphicsEffect):
    """ QGraphicsOpacityEffect(parent: Optional[QObject] = None) """
    ...
    def setOpacityMask(self, mask, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ setOpacityMask(self, mask: Union[QBrush, Union[QColor, Qt.GlobalColor], QGradient]) """
        pass

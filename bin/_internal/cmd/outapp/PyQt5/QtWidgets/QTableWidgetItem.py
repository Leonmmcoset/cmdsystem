...
class QTableWidgetItem(__sip.wrapper):
    """
    QTableWidgetItem(type: int = QTableWidgetItem.ItemType.Type)
    QTableWidgetItem(text: Optional[str], type: int = QTableWidgetItem.ItemType.Type)
    QTableWidgetItem(icon: QIcon, text: Optional[str], type: int = QTableWidgetItem.ItemType.Type)
    ...
    def clone(self): # real signature unknown; restored from __doc__
        """ clone(self) -> Optional[QTableWidgetItem] """
        pass
    ...
    def tableWidget(self): # real signature unknown; restored from __doc__
        """ tableWidget(self) -> Optional[QTableWidget] """
        pass

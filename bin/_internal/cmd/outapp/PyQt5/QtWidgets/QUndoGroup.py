...
class QUndoGroup(__PyQt5_QtCore.QObject):
    """ QUndoGroup(parent: Optional[QObject] = None) """
    def activeStack(self): # real signature unknown; restored from __doc__
        """ activeStack(self) -> Optional[QUndoStack] """
        pass
    ...
    def addStack(self, stack, QUndoStack=None): # real signature unknown; restored from __doc__
        """ addStack(self, stack: Optional[QUndoStack]) """
        pass
    ...
    def removeStack(self, stack, QUndoStack=None): # real signature unknown; restored from __doc__
        """ removeStack(self, stack: Optional[QUndoStack]) """
        pass
    ...
    def setActiveStack(self, stack, QUndoStack=None): # real signature unknown; restored from __doc__
        """ setActiveStack(self, stack: Optional[QUndoStack]) """
        pass

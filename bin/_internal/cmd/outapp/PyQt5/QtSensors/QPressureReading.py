...
class QPressureReading(QSensorReading):
    ...
    def setPressure(self, pressure): # real signature unknown; restored from __doc__
        """ setPressure(self, pressure: float) """
        pass

    def setTemperature(self, temperature): # real signature unknown; restored from __doc__
        """ setTemperature(self, temperature: float) """
        pass

...
class QTapFilter(QSensorFilter):
    """
    QTapFilter()
    QTapFilter(a0: QTapFilter)
    """
    def filter(self, reading, QTapReading=None): # real signature unknown; restored from __doc__
        """ filter(self, reading: Optional[QTapReading]) -> bool """
        return False

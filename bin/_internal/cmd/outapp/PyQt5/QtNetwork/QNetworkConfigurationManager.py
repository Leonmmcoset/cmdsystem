...
class QNetworkConfigurationManager(__PyQt5_QtCore.QObject):
    """ QNetworkConfigurationManager(parent: Optional[QObject] = None) """
    ...
    def configurationFromIdentifier(self, identifier, p_str=None): # real signature unknown; restored from __doc__
        """ configurationFromIdentifier(self, identifier: Optional[str]) -> QNetworkConfiguration """

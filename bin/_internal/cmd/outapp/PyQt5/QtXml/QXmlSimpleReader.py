...
class QXmlSimpleReader(QXmlReader):
    ...
    def parse(self, input, QXmlInputSource=None, *args=None, **kwargs=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        parse(self, input: Optional[QXmlInputSource]) -> bool
        parse(self, input: Optional[QXmlInputSource], incremental: bool) -> bool
        """
        return False

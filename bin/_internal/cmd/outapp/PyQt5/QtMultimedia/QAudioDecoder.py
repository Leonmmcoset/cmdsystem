...
class QAudioDecoder(QMediaObject):
    """ QAudioDecoder(parent: Optional[QObject] = None) """
    ...
    def hasSupport(self, mimeType, p_str=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ hasSupport(mimeType: Optional[str], codecs: Iterable[Optional[str]] = []) -> QMultimedia.SupportEstimate """
        pass
    ...
    def setSourceDevice(self, device, QIODevice=None): # real signature unknown; restored from __doc__
        """ setSourceDevice(self, device: Optional[QIODevice]) """
        pass

    def setSourceFilename(self, fileName, p_str=None): # real signature unknown; restored from __doc__
        """ setSourceFilename(self, fileName: Optional[str]) """
        pass
    ...
    def sourceDevice(self): # real signature unknown; restored from __doc__
        """ sourceDevice(self) -> Optional[QIODevice] """
        pass

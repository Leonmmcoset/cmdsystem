...
class QAudioRoleControl(QMediaControl):
    """ QAudioRoleControl(parent: Optional[QObject] = None) """
    ...
    def setAudioRole(self, role): # real signature unknown; restored from __doc__
        """ setAudioRole(self, role: QAudio.Role) """
        pass

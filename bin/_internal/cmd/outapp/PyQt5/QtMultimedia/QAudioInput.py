...
class QAudioInput(__PyQt5_QtCore.QObject):
    """
    QAudioInput(format: QAudioFormat = QAudioFormat(), parent: Optional[QObject] = None)
    QAudioInput(audioDevice: QAudioDeviceInfo, format: QAudioFormat = QAudioFormat(), parent: Optional[QObject] = None)
    """

...
class QCameraImageCaptureControl(QMediaControl):
    """ QCameraImageCaptureControl(parent: Optional[QObject] = None) """
    def cancelCapture(self): # real signature unknown; restored from __doc__
        """ cancelCapture(self) """
        pass

    def capture(self, fileName, p_str=None): # real signature unknown; restored from __doc__
        """ capture(self, fileName: Optional[str]) -> int """
        return 0
    ...
    def setDriveMode(self, mode): # real signature unknown; restored from __doc__
        """ setDriveMode(self, mode: QCameraImageCapture.DriveMode) """
        pass

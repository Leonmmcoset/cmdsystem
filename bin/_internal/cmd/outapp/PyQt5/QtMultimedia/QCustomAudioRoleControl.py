...
class QCustomAudioRoleControl(QMediaControl):
    """ QCustomAudioRoleControl(parent: Optional[QObject] = None) """
    ...
    def setCustomAudioRole(self, role, p_str=None): # real signature unknown; restored from __doc__
        """ setCustomAudioRole(self, role: Optional[str]) """
        pass

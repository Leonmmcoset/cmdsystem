...
class QMediaPlayerControl(QMediaControl):
    """ QMediaPlayerControl(parent: Optional[QObject] = None) """
    ...
    def availablePlaybackRangesChanged(self, *args, **kwargs): # real signature unknown
        """
        pyqtSignal(*types, name: str = ..., revision: int = ..., arguments: Sequence = ...) -> PYQT_SIGNAL
    ...
    def setMedia(self, media, stream, QIODevice=None): # real signature unknown; restored from __doc__
        """ setMedia(self, media: QMediaContent, stream: Optional[QIODevice]) """
        pass

    def setMuted(self, mute): # real signature unknown; restored from __doc__
        """ setMuted(self, mute: bool) """
        pass

# encoding: utf-8
# module pygame.color
# from C:\Users\leonm\PycharmProjects\leonsystem\venv\Lib\site-packages\pygame\color.cp311-win_amd64.pyd
# by generator 1.147
...
class Color(object):
    ...
    def grayscale(self): # real signature unknown; restored from __doc__
        """
        grayscale() -> Color
...
_PYGAME_C_API = None # (!) real value is '<capsule object "pygame.color._PYGAME_C_API" at 0x000001C0054620D0>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001C00545D750>'

__spec__ = None # (!) real value is "ModuleSpec(name='pygame.color', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001C00545D750>, origin='C:\\\\Users\\\\leonm\\\\PycharmProjects\\\\leonsystem\\\\venv\\\\Lib\\\\site-packages\\\\pygame\\\\color.cp311-win_amd64.pyd')"

...
class Sequence(__collections_abc.Reversible, __collections_abc.Collection):
    ...
    _abc_impl = None # (!) real value is '<_abc._abc_data object at 0x000001BBCE51A640>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x000001BBEEDFA010>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.random._generator', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x000001BBEEDFA010>, origin='C:\\\\Users\\\\leonm\\\\PycharmProjects\\\\leonsystem\\\\venv\\\\Lib\\\\site-packages\\\\numpy\\\\random\\\\_generator.cp311-win_amd64.pyd')"

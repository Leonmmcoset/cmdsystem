...
class Philox(__numpy_random_bit_generator.BitGenerator):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000020F0234AAF0>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x0000020F0233BED0>'

__spec__ = None # (!) real value is "ModuleSpec(name='numpy.random._philox', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x0000020F0233BED0>, origin='C:\\\\Users\\\\leonm\\\\PycharmProjects\\\\leonsystem\\\\venv\\\\Lib\\\\site-packages\\\\numpy\\\\random\\\\_philox.cp311-win_amd64.pyd')"

...
class QWriteLocker(__sip.simplewrapper):
    """ QWriteLocker(areadWriteLock: Optional[QReadWriteLock]) """
    def readWriteLock(self): # real signature unknown; restored from __doc__
        """ readWriteLock(self) -> Optional[QReadWriteLock] """
        pass
    ...
    def __init__(self, areadWriteLock, QReadWriteLock=None): # real signature unknown; restored from __doc__
        pass

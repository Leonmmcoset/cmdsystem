...
class QCameraControl(QMediaControl):
    """ QCameraControl(parent: Optional[QObject] = None) """
    def canChangeProperty(self, changeType, status): # real signature unknown; restored from __doc__
        """ canChangeProperty(self, changeType: QCameraControl.PropertyChangeType, status: QCamera.Status) -> bool """
        return False
    ...
    def setCaptureMode(self, a0, QCamera_CaptureModes=None, QCamera_CaptureMode=None): # real signature unknown; restored from __doc__
        """ setCaptureMode(self, a0: Union[QCamera.CaptureModes, QCamera.CaptureMode]) """
        pass

    def setState(self, state): # real signature unknown; restored from __doc__
        """ setState(self, state: QCamera.State) """
        pass

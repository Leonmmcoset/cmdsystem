...
class QAudioOutputSelectorControl(QMediaControl):
    """ QAudioOutputSelectorControl(parent: Optional[QObject] = None) """
    def activeOutput(self): # real signature unknown; restored from __doc__
        """ activeOutput(self) -> str """
        return ""

    def activeOutputChanged(self, *args, **kwargs): # real signature unknown
        """
    ...
    def availableOutputsChanged(self, *args, **kwargs): # real signature unknown
        """
        pyqtSignal(*types, name: str = ..., revision: int = ..., arguments: Sequence = ...) -> PYQT_SIGNAL
    ...
    def outputDescription(self, name, p_str=None): # real signature unknown; restored from __doc__
        """ outputDescription(self, name: Optional[str]) -> str """
        return ""
    ...
    def setActiveOutput(self, name, p_str=None): # real signature unknown; restored from __doc__
        """ setActiveOutput(self, name: Optional[str]) """
        pass

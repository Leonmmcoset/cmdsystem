...
class QAudioRecorder(QMediaRecorder):
    """ QAudioRecorder(parent: Optional[QObject] = None) """
    ...
    def audioInputDescription(self, name, p_str=None): # real signature unknown; restored from __doc__
        """ audioInputDescription(self, name: Optional[str]) -> str """
        return ""
    ...
    def setAudioInput(self, name, p_str=None): # real signature unknown; restored from __doc__
        """ setAudioInput(self, name: Optional[str]) """
        pass

...
class QMagnetometer(QSensor):
    """ QMagnetometer(parent: Optional[QObject] = None) """
    ...
    def reading(self): # real signature unknown; restored from __doc__
        """ reading(self) -> Optional[QMagnetometerReading] """
        pass
    ...
    def setReturnGeoValues(self, returnGeoValues): # real signature unknown; restored from __doc__
        """ setReturnGeoValues(self, returnGeoValues: bool) """
        pass

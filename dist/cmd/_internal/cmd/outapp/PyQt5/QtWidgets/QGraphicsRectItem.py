...
class QGraphicsRectItem(QAbstractGraphicsShapeItem):
    """
    QGraphicsRectItem(parent: Optional[QGraphicsItem] = None)
    QGraphicsRectItem(rect: QRectF, parent: Optional[QGraphicsItem] = None)
    QGraphicsRectItem(x: float, y: float, w: float, h: float, parent: Optional[QGraphicsItem] = None)
    """

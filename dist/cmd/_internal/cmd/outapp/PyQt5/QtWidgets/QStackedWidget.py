...
class QStackedWidget(QFrame):
    """ QStackedWidget(parent: Optional[QWidget] = None) """
    ...
    def indexOf(self, a0, QWidget=None): # real signature unknown; restored from __doc__
    ...
    def widget(self, a0): # real signature unknown; restored from __doc__

...
class ConditionVarDirect(__dtoolconfig.DTOOL_SUPER_BASE):
    """
    /**
    ...
    def get_mutex(self, ConditionVarDirect_self): # real signature unknown; restored from __doc__
        """
        C++ Interface:
        get_mutex(ConditionVarDirect self)
    ...
    def notify(self, const_ConditionVarDirect_self): # real signature unknown; restored from __doc__
        """
        C++ Interface:
    ...
    def output(self, ConditionVarDirect_self, ostream_out): # real signature unknown; restored from __doc__
        """
        C++ Interface:
    ...
    def wait(self, const_ConditionVarDirect_self): # real signature unknown; restored from __doc__
        """
        C++ Interface:
    ...
    DtoolClassDict = {
        ...
        '__doc__': '/**\n * A condition variable, usually used to communicate information about\n * changing state to a thread that is waiting for something to happen.  A\n * condition variable can be used to "wake up" a thread when some arbitrary\n * condition has changed.\n *\n * A condition variable is associated with a single mutex, and several\n * condition variables may share the same mutex.\n */',
        '__init__': None, # (!) real value is "<slot wrapper '__init__' of 'panda3d.core.ConditionVarDirect' objects>"
        '__new__': None, # (!) real value is '<built-in method __new__ of type object at 0x00007FFCFE2EB6D0>'
        '__repr__': None, # (!) real value is "<slot wrapper '__repr__' of 'panda3d.core.ConditionVarDirect' objects>"
        '__str__': None, # (!) real value is "<slot wrapper '__str__' of 'panda3d.core.ConditionVarDirect' objects>"
        'getMutex': None, # (!) real value is "<method 'getMutex' of 'panda3d.core.ConditionVarDirect' objects>"
        'get_mutex': None, # (!) real value is "<method 'get_mutex' of 'panda3d.core.ConditionVarDirect' objects>"
        'notify': None, # (!) real value is "<method 'notify' of 'panda3d.core.ConditionVarDirect' objects>"
        'output': None, # (!) real value is "<method 'output' of 'panda3d.core.ConditionVarDirect' objects>"
        'wait': None, # (!) real value is "<method 'wait' of 'panda3d.core.ConditionVarDirect' objects>"
    }

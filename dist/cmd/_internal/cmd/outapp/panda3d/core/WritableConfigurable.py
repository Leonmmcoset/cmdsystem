...
class WritableConfigurable(TypedWritable):
    ...
    DtoolClassDict = {
        ...
        '__doc__': '/**\n * Defined as a fix to allow creating Configurable and Writable objects.\n * Otherwise the compiler gets confused since both TypedWritable and\n * Configurable inherit from TypedObject.\n *\n * An object that has data or parameters that are set less frequently (at\n * least occasionally) than every frame.  We can cache the configuration info\n * by by using the "dirty" flag.\n */',
        '__init__': None, # (!) real value is "<slot wrapper '__init__' of 'panda3d.core.WritableConfigurable' objects>"
        '__new__': None, # (!) real value is '<built-in method __new__ of type object at 0x00007FFCFE3751A0>'
        'getClassType': None, # (!) real value is '<staticmethod(<built-in method getClassType of type object at 0x00007FFCFE3751A0>)>'
        'get_class_type': None, # (!) real value is '<staticmethod(<built-in method get_class_type of type object at 0x00007FFCFE3751A0>)>'
    }

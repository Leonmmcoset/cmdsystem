...
from .AngularIntegrator import AngularIntegrator
...
class AngularEulerIntegrator(AngularIntegrator):
    ...
    DtoolClassDict = {
        ...
        '__doc__': '/**\n * Performs Euler integration on a vector of physically modelable objects\n * given a quantum dt.\n */',
        '__init__': None, # (!) real value is "<slot wrapper '__init__' of 'panda3d.physics.AngularEulerIntegrator' objects>"
        '__new__': None, # (!) real value is '<built-in method __new__ of type object at 0x00007FFDC9DEC600>'
    }

...
class LinearIntegrator(BaseIntegrator):
    ...
    DtoolClassDict = {
        ...
        '__doc__': '/**\n * Pure virtual base class for physical modeling.  Takes physically modelable\n * objects and applies forces to them.\n */',
        '__init__': None, # (!) real value is "<slot wrapper '__init__' of 'panda3d.physics.LinearIntegrator' objects>"
        '__new__': None, # (!) real value is '<built-in method __new__ of type object at 0x00007FFDC9DED0E0>'
    }
